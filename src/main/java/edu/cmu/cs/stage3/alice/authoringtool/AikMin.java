...
public class AikMin {
	...
	// Set locale and language from argument only if it is not already set in the preferences.
	public static void initializeLocale(String defaultLanguage){
		...
		if( authoringtoolConfig.getValue( "language" ) == null ) {
			locale = defaultLanguage != null ? new Locale (defaultLanguage) : english;
			authoringtoolConfig.setValue( "language", locale.getDisplayLanguage() );
		} else {
			locale = english;
	...
	// Return the active language (in English) to use in filenames
	public static String getLanguage() {
		return locale.getDisplayLanguage(english);
	}
	...
	public static boolean isLTR(){
		// TODO expand if other languages are supported (e.g. "he", "dv", "fa", etc)
