...
public class MoviePlayer
{
	...
	public MoviePlayer()
	{
		SimpleOutput.showInformation(Messages.getString("Please_pick_a_directory_that_contains_the_JPEG_frames")); 
	...
	public void showNext()
	{
		...
		frameLabel.setText(Messages.getString("Frame_Number_", animationPanel.getCurrIndex()));
		frame.repaint();
	}
