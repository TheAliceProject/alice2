...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
	...
	private void setUpNextAndPreviousButtons()
	{
		...
		Icon prevIcon = new ImageIcon(SoundExplorer.class.getResource("leftArrow.gif"), Messages.getString("previous_index")); 
		Icon nextIcon = new ImageIcon(SoundExplorer.class.getResource("rightArrow.gif"), Messages.getString("next_index")); 
