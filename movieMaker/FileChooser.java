...
public class FileChooser 
{
	...
	public static String getMediaPath(String fileName) 
	{
		...
		if (directory == null)
		{
			SimpleOutput.showError(Messages.getString("The_media_path__directory_has_not_been_set_yet_")); 
			pickMediaPath();
	...
	{ 
		...
		if (!file.exists())
		{
			System.out.println(Messages.getString("Sorry_but_doesn_t_exist__try_a_different_directory_", directory)); 
			...
			try {
				...
				appProperties.store(out, Messages.getString("Properties_for_the_Simple_Picture_class")); 
				out.close();
