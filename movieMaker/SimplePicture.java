...
public class SimplePicture implements DigitalPicture
{
	...
	public void loadOrFail(String fileName) throws IOException
	{
		...
		if (!file.canRead()) 
		{
			...
			if (!file.canRead())
			{
				throw new IOException(Messages.getString("could_not_be_opened__Check_that_you_specified_the_path", this.fileName)); 
			}
		}
	...
	public void writeOrFail(String fileName) throws IOException
	{
		...
		if (!fileLoc.canWrite()) {
			...
			throw new IOException( Messages.getString("could_not_be_opened__Check_to_see_if_you_can_write_to_the_directory_", fileName )); 
		}
	...
	{
		String output = Messages.getString("Simple_Picture__filename_height_width_", fileName, getHeight(), getWidth());  
		return output;
	}
