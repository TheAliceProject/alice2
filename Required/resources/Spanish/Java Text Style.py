...
formatMap = {
	...
	edu.cmu.cs.stage3.alice.core.responses.MoveTowardAnimation : "<<<subject>>>.acercarseA( <target>, <amount> );",
	edu.cmu.cs.stage3.alice.core.responses.MoveAwayFromAnimation : "<<<subject>>>.alejarseDe( <target>, <amount> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.MoveAtSpeed : "<<<subject>>>.moverConVelocidad( <direction>, <speed> );",
	edu.cmu.cs.stage3.alice.core.responses.TurnAtSpeed : "<<<subject>>>.girarConVelocidad( <direction>, <speed> );",
	edu.cmu.cs.stage3.alice.core.responses.RollAtSpeed : "<<<subject>>>.rodarConVelocidad( <direction>, <speed> );",
	edu.cmu.cs.stage3.alice.core.responses.ResizeAnimation : "<<<subject>>>.cambiarElTamaño( <amount> );",
	edu.cmu.cs.stage3.alice.core.responses.PointAtAnimation : "<<<subject>>>.girarApuntarA( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.TurnToFaceAnimation : "<<<subject>>>.girarParaEncararA( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.TurnAwayFromAnimation : "<<<subject>>>.girarParaAlejarseDe( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.PointAtConstraint : "<<<subject>>>.restringidoParaApuntarA( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.GetAGoodLookAtAnimation : "<<<subject>>>.tomarUnaBuenaMirada( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.StandUpAnimation : "<<<subject>>>.pararse();",
	edu.cmu.cs.stage3.alice.core.responses.PositionAnimation : "<<<subject>>>.moverA( <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.responses.PlaceAnimation : "<<<subject>>>.colocar( <amount>, <spatialRelation>, <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.responses.QuaternionAnimation : "<<<subject>>>.orientarA( <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.responses.PointOfViewAnimation : "<<<subject>>>.establecerElPuntoDeVista( <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation : "<element>.establecer( <propertyName>, <value> );",
	edu.cmu.cs.stage3.alice.core.responses.SoundResponse : "<<<subject>>>.reproducirSonido( <sound> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.ScriptResponse : "Guion (Script)( <script> );",
	edu.cmu.cs.stage3.alice.core.responses.ScriptDefinedResponse : "respuestaDefinidaPorElGuion( <script> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.PoseAnimation : "<<<subject>>>.establecerPose( <pose> );",
	edu.cmu.cs.stage3.alice.core.responses.Increment : "<<<variable>>>++",
	edu.cmu.cs.stage3.alice.core.responses.Decrement : "<<<variable>>>--",

	edu.cmu.cs.stage3.alice.core.responses.VehiclePropertyAnimation : "<element>.establecer( <propertyName>, <value> );",

	edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtBeginning : "<<<list>>>.insertar( 0, <item> );",
	edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtEnd : "<<<list>>>.insertar( <item> );",
	edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtIndex : "<<<list>>>.insertar( <index>, <item> );",
	edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromBeginning : "<<<list>>>.eliminar( 0 );",
	edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromEnd : "<<<list>>>.eliminarElUltimo();", 
	edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromIndex : "<<<list>>>.eliminar( <index> );",
	edu.cmu.cs.stage3.alice.core.responses.list.Clear : "<<<list>>>.borrar();",

	edu.cmu.cs.stage3.alice.core.responses.array.SetItemAtIndex : "<<<array>>>[<index>] = <item>;",

	edu.cmu.cs.stage3.alice.core.responses.vector3.SetX : "<<<vector3>>>.establecerDistanciaALaDerecha( <value> )",
	edu.cmu.cs.stage3.alice.core.responses.vector3.SetY : "<<<vector3>>>.establecerDistanciaHaciaArriba( <value> )",
	edu.cmu.cs.stage3.alice.core.responses.vector3.SetZ : "<<<vector3>>>.establecerDistanciaAlFrente( <value> )",
...
nameMap = {
	"edu.cmu.cs.stage3.alice.core.responses.DoInOrder" : "hacerEnOrden",
	"edu.cmu.cs.stage3.alice.core.responses.DoTogether" : "hacerJuntos",
	...
	"edu.cmu.cs.stage3.alice.core.responses.ForEachInOrder" : "paraTodosEnOrden",
	"edu.cmu.cs.stage3.alice.core.responses.ForEachTogether" : "paraTodosJuntos",
	...
	"edu.cmu.cs.stage3.alice.core.responses.PositionAnimation.position" : "posición de",
	...
	edu.cmu.cs.stage3.alice.core.styles.TraditionalAnimationStyle.BEGIN_AND_END_GENTLY : "COMENZAR_Y_TERMINAR_SUAVEMENTE",
	edu.cmu.cs.stage3.alice.core.styles.TraditionalAnimationStyle.BEGIN_GENTLY_AND_END_ABRUPTLY : "COMENZAR_SUAVEMENTE_Y_TERMINAR_ABRUPTAMENTE",
	edu.cmu.cs.stage3.alice.core.styles.TraditionalAnimationStyle.BEGIN_ABRUPTLY_AND_END_GENTLY : "COMENZAR_ABRUPTAMENTE_Y_TERMINAR_SUAVEMENTE",
	edu.cmu.cs.stage3.alice.core.styles.TraditionalAnimationStyle.BEGIN_AND_END_ABRUPTLY : "COMENZAR_Y_TERMINAR_ABRUPTAMENTE",
