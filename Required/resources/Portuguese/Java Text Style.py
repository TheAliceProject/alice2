...
formatMap = {
	...
	edu.cmu.cs.stage3.alice.core.responses.MoveTowardAnimation : "<<<subject>>>.movaNaDireçãoDe( <target>, <amount> );",
	edu.cmu.cs.stage3.alice.core.responses.MoveAwayFromAnimation : "<<<subject>>>.afasteDe( <target>, <amount> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.PointAtConstraint : "<<<subject>>>.restringeParaOPontoEm( <target> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.ScriptDefinedResponse : "respostaDeRoteiroDefinido( <script> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.vector3.SetX : "<<<vector3>>>.definaDistânciaDireita( <value> )",
	edu.cmu.cs.stage3.alice.core.responses.vector3.SetY : "<<<vector3>>>.definaDistânciaAcima( <value> )",
	edu.cmu.cs.stage3.alice.core.responses.vector3.SetZ : "<<<vector3>>>.definaDistânciaAdiante( <value> )",
...
nameMap = {
	...
	"edu.cmu.cs.stage3.alice.core.behaviors.MouseLookingBehavior" : "Deixe <mouse> orientar a câmera",
