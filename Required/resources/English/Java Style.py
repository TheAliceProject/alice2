...
formatMap = {
	...
	edu.cmu.cs.stage3.alice.core.responses.MoveTowardAnimation : "<<<subject>>>.moveToward( <target>, <amount> );",
	edu.cmu.cs.stage3.alice.core.responses.MoveAwayFromAnimation : "<<<subject>>>.moveAwayFrom( <target>, <amount> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.MoveAtSpeed : "<<<subject>>>.moveAtSpeed( <direction>, <speed> );",
	edu.cmu.cs.stage3.alice.core.responses.TurnAtSpeed : "<<<subject>>>.turnAtSpeed( <direction>, <speed> );",
	edu.cmu.cs.stage3.alice.core.responses.RollAtSpeed : "<<<subject>>>.rollAtSpeed( <direction>, <speed> );",
	edu.cmu.cs.stage3.alice.core.responses.ResizeAnimation : "<<<subject>>>.resize( <amount> );",
	edu.cmu.cs.stage3.alice.core.responses.PointAtAnimation : "<<<subject>>>.pointAt( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.TurnToFaceAnimation : "<<<subject>>>.turnToFace( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.TurnAwayFromAnimation : "<<<subject>>>.turnAwayFrom( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.PointAtConstraint : "<<<subject>>>.constrainToPointAt( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.GetAGoodLookAtAnimation : "<<<subject>>>.getAGoodLookAt( <target> );",
	edu.cmu.cs.stage3.alice.core.responses.StandUpAnimation : "<<<subject>>>.standUp();",
	edu.cmu.cs.stage3.alice.core.responses.PositionAnimation : "<<<subject>>>.moveTo( <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.responses.PlaceAnimation : "<<<subject>>>.place( <amount>, <spatialRelation>, <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.responses.QuaternionAnimation : "<<<subject>>>.orientTo( <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.responses.PointOfViewAnimation : "<<<subject>>>.setPointOfView( <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation : "<element>.set( <propertyName>, <value> );",
	edu.cmu.cs.stage3.alice.core.responses.SoundResponse : "<<<subject>>>.playSound( <sound> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.ScriptDefinedResponse : "scriptDefinedResponse( <script> );",
	...
	edu.cmu.cs.stage3.alice.core.responses.PoseAnimation : "<<<subject>>>.setPose( <pose> );",
	edu.cmu.cs.stage3.alice.core.responses.Increment : "<<<variable>>>++",
	edu.cmu.cs.stage3.alice.core.responses.Decrement : "<<<variable>>>--",

	edu.cmu.cs.stage3.alice.core.responses.VehiclePropertyAnimation : "<element>.set( <propertyName>, <value> );",

	edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtBeginning : "<<<list>>>.add( 0, <item> );",
	edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtEnd : "<<<list>>>.add( <item> );",
	edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtIndex : "<<<list>>>.add( <index>, <item> );",
	edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromBeginning : "<<<list>>>.remove( 0 );",
	edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromEnd : "<<<list>>>.removeLast();", 
	edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromIndex : "<<<list>>>.remove( <index> );",
	edu.cmu.cs.stage3.alice.core.responses.list.Clear : "<<<list>>>.clear();",

	edu.cmu.cs.stage3.alice.core.responses.array.SetItemAtIndex : "<<<array>>>[<index>] = <item>;",

	edu.cmu.cs.stage3.alice.core.responses.vector3.SetX : "<<<vector3>>>.setDistanceRight( <value> )",
	edu.cmu.cs.stage3.alice.core.responses.vector3.SetY : "<<<vector3>>>.setDistanceUp( <value> )",
	edu.cmu.cs.stage3.alice.core.responses.vector3.SetZ : "<<<vector3>>>.setDistanceForward( <value> )",
...
nameMap = {
	"edu.cmu.cs.stage3.alice.core.responses.DoInOrder" : "doInOrder",
	"edu.cmu.cs.stage3.alice.core.responses.DoTogether" : "doTogether",
	"edu.cmu.cs.stage3.alice.core.responses.IfElseInOrder" : "if",
	"edu.cmu.cs.stage3.alice.core.responses.LoopNInOrder" : "loop",
	"edu.cmu.cs.stage3.alice.core.responses.WhileLoopInOrder" : "while",
	"edu.cmu.cs.stage3.alice.core.responses.ForEachInOrder" : "forAllInOrder",
	"edu.cmu.cs.stage3.alice.core.responses.ForEachTogether" : "forAllTogether",
	"edu.cmu.cs.stage3.alice.core.responses.Print" : "print",
	"edu.cmu.cs.stage3.alice.core.responses.QuaternionAnimation.quaternion" : "orientation of",
	"edu.cmu.cs.stage3.alice.core.responses.PointOfViewAnimation.pointOfView" : "point of view of",
	"edu.cmu.cs.stage3.alice.core.responses.PositionAnimation.position" : "position of",
	...
	edu.cmu.cs.stage3.alice.core.styles.TraditionalAnimationStyle.BEGIN_AND_END_GENTLY : "BEGIN_AND_END_GENTLY",
	edu.cmu.cs.stage3.alice.core.styles.TraditionalAnimationStyle.BEGIN_GENTLY_AND_END_ABRUPTLY : "BEGIN_GENTLY_AND_END_ABRUPTLY",
	edu.cmu.cs.stage3.alice.core.styles.TraditionalAnimationStyle.BEGIN_ABRUPTLY_AND_END_GENTLY : "BEGIN_ABRUPTLY_AND_END_GENTLY",
	edu.cmu.cs.stage3.alice.core.styles.TraditionalAnimationStyle.BEGIN_AND_END_ABRUPTLY : "BEGIN_AND_END_ABRUPTLY",
