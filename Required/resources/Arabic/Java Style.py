...
formatMap = {
	...
	edu.cmu.cs.stage3.alice.core.response.MoveTowardAnimation : "<<<subject>>>.تحرك باتجاه( <target>, <amount> );",
	edu.cmu.cs.stage3.alice.core.response.MoveAwayFromAnimation : "<<<subject>>>.تحرك بعيدًا عن( <target>, <amount> );",
	...
	edu.cmu.cs.stage3.alice.core.response.PlaceAnimation : "<<<subject>>>.ضع( <amount>, <spatialRelation>, <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.response.QuaternionAnimation : "<<<subject>>>.توجّه إلى( <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.response.PointOfViewAnimation : "<<<subject>>>. ضبط زاوية النظر ( <asSeenBy> );",
	edu.cmu.cs.stage3.alice.core.response.PropertyAnimation : "<element>.ضبط( <propertyName>, <value> );",
	...
	edu.cmu.cs.stage3.alice.core.response.ThinkAnimation : "<<<subject>>>.فكّر( <what> );",
	...
	edu.cmu.cs.stage3.pratt.maxkeyframing.KeyframeResponse : " تشغيل إطار الرسوم المتحركة الرئيس على ( <subject> );",
	edu.cmu.cs.stage3.alice.core.response.PoseAnimation : "<<<subject>>>.تحديد الوضع( <pose> );",
	edu.cmu.cs.stage3.alice.core.response.Increment : "<<<variable>>>++",
	edu.cmu.cs.stage3.alice.core.response.Decrement : "<<<variable>>>--",

	edu.cmu.cs.stage3.alice.core.response.VehiclePropertyAnimation : "<element>.تحديد( <propertyName>, <value> );",

	edu.cmu.cs.stage3.alice.core.response.list.InsertItemAtBeginning : "<<<list>>>.أضف( 0, <item> );",
	edu.cmu.cs.stage3.alice.core.response.list.InsertItemAtEnd : "<<<list>>>.أضف( <item> );",
	edu.cmu.cs.stage3.alice.core.response.list.InsertItemAtIndex : "<<<list>>>.أضف( <index>, <item> );",
	edu.cmu.cs.stage3.alice.core.response.list.RemoveItemFromBeginning : "<<<list>>>.أزل( 0 );",
	edu.cmu.cs.stage3.alice.core.response.list.RemoveItemFromEnd : "<<<list>>>.أزل الأخير();", 
	edu.cmu.cs.stage3.alice.core.response.list.RemoveItemFromIndex : "<<<list>>>.أزل( <index> );",
	edu.cmu.cs.stage3.alice.core.response.list.Clear : "<<<list>>>.امسح();",

	edu.cmu.cs.stage3.alice.core.response.array.SetItemAtIndex : "<<<array>>>[<index>] = <item>;",

	edu.cmu.cs.stage3.alice.core.response.vector3.SetX : "<<<vector3>>>.ضبط المسافة إلى اليمين( <value> )",
	edu.cmu.cs.stage3.alice.core.response.vector3.SetY : "<<<vector3>>>.ضبط المسافة إلى الأعلى( <value> )",
	edu.cmu.cs.stage3.alice.core.response.vector3.SetZ : "<<<vector3>>>.ضبط المسافة إلى الأمام( <value> )",
...
nameMap = {
	...
	"edu.cmu.cs.stage3.alice.core.response.IfElseInOrder" : "إذا",
	...
	"edu.cmu.cs.stage3.alice.core.response.QuaternionAnimation.quaternion" : "توجيه ل",
	"edu.cmu.cs.stage3.alice.core.response.PointOfViewAnimation.pointOfView" : "زاوية النظر ل",
	"edu.cmu.cs.stage3.alice.core.response.PositionAnimation.position" : "موضع ال",
	...
	"edu.cmu.cs.stage3.alice.core.behavior.KeyIsPressedBehavior" : "بينما <keyCode> يُضغط",
	"edu.cmu.cs.stage3.alice.core.behavior.MouseButtonClickBehavior" : "عندما <mouse> يُضغط على <onWhat>",
	"edu.cmu.cs.stage3.alice.core.behavior.MouseButtonIsPressedBehavior" : "بينما <mouse> يُضغط على <onWhat>",
	...
	"edu.cmu.cs.stage3.alice.core.behavior.MouseLookingBehavior" : "دع <mouse> يوجّه الكاميرا",
	...
	edu.cmu.cs.stage3.alice.core.style.TraditionalAnimationStyle.BEGIN_AND_END_GENTLY : "إبدأ وانهي رويدًا ",
	edu.cmu.cs.stage3.alice.core.style.TraditionalAnimationStyle.BEGIN_GENTLY_AND_END_ABRUPTLY : "إبدأ رويدًا وانهي فجأة",
	edu.cmu.cs.stage3.alice.core.style.TraditionalAnimationStyle.BEGIN_ABRUPTLY_AND_END_GENTLY : " إبدأ فجأة وانهي رويدًا",
	edu.cmu.cs.stage3.alice.core.style.TraditionalAnimationStyle.BEGIN_AND_END_ABRUPTLY : " إبدأ وانهي فجأة ",
