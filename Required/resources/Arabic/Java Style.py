...
nameMap = {
	...
	"edu.cmu.cs.stage3.alice.core.behaviors.MouseButtonClickBehavior" : "عندما <mouse> يُضغط على <onWhat>",
	"edu.cmu.cs.stage3.alice.core.behaviors.MouseButtonIsPressedBehavior" : "بينما <mouse> يُضغط على <onWhat>",
