...
formatMap = {
	edu.cmu.cs.stage3.alice.core.response.MoveAnimation : "<<<subject>>> تحرك <<direction>><<amount>>",
	edu.cmu.cs.stage3.alice.core.response.MoveTowardAnimation : "<<<subject>>> تحرك <<amount>> باتجاه <<target>>",
	edu.cmu.cs.stage3.alice.core.response.MoveAwayFromAnimation : "<<<subject>>> تحرك <<amount>> بعيدًا عن <<target>>",
	edu.cmu.cs.stage3.alice.core.response.TurnAnimation : "<<<subject>>> استدر <<direction>><<amount>>",
	edu.cmu.cs.stage3.alice.core.response.RollAnimation : "<<<subject>>> لف <<direction>><<amount>>",
	edu.cmu.cs.stage3.alice.core.response.MoveAtSpeed : "<<<subject>>> تحرك بسرعة <<direction>><<speed>>",
	edu.cmu.cs.stage3.alice.core.response.TurnAtSpeed : "<<<subject>>> استدر بسرعة <<direction>><<speed>>",
	edu.cmu.cs.stage3.alice.core.response.RollAtSpeed : "<<<subject>>> لف بسرعة  <<direction>><<speed>>",
	edu.cmu.cs.stage3.alice.core.response.ResizeAnimation : "<<<subject>>> غير الحجم <<amount>>",
	edu.cmu.cs.stage3.alice.core.response.PointAtAnimation : "<<<subject>>> أشر إلى <<target>>",
	edu.cmu.cs.stage3.alice.core.response.TurnToFaceAnimation : "<<<subject>>> استدر لمواجهة <<target>>",
	edu.cmu.cs.stage3.alice.core.response.TurnAwayFromAnimation : "<<<subject>>> استدر بعيدًا عن <<target>>",
	edu.cmu.cs.stage3.alice.core.response.PointAtConstraint : "<<<subject>>> تقيّد بالإشارة إلى <<target>>",
	edu.cmu.cs.stage3.alice.core.response.TurnToFaceConstraint : "<<<subject>>> تقيّد بمواجهة  <<target>>",
	edu.cmu.cs.stage3.alice.core.response.TurnAwayFromConstraint : "<<<subject>>> تقيّد بمواجهة بعيدًا عن  <<target>>",
	edu.cmu.cs.stage3.alice.core.response.GetAGoodLookAtAnimation : "<<<subject>>> انظر جيدًا إلى <<target>>",
	edu.cmu.cs.stage3.alice.core.response.StandUpAnimation : "<<<subject>>> قف",
	edu.cmu.cs.stage3.alice.core.response.PositionAnimation : "<<<subject>>> تحرك إلى <<asSeenBy>>",
	edu.cmu.cs.stage3.alice.core.response.PlaceAnimation : "<<<subject>>> caitlin تحرك إلى <<amount>><<spatialRelation>><<asSeenBy>>",
	edu.cmu.cs.stage3.alice.core.response.QuaternionAnimation : "<<<subject>>> توجّه إلى <<asSeenBy>>",
	edu.cmu.cs.stage3.alice.core.response.PointOfViewAnimation : "<<<subject>>> ضبط زاوية النظر إلى <<asSeenBy>>",
	edu.cmu.cs.stage3.alice.core.response.PropertyAnimation : "<<<element>>> ضبط <propertyName> إلى <<value>>",
	edu.cmu.cs.stage3.alice.core.response.SoundResponse : "<<<subject>>> شغّل الصوت <<sound>>",
	edu.cmu.cs.stage3.alice.core.response.Wait : "انتظر <<duration>>",
	edu.cmu.cs.stage3.alice.core.response.Comment : "// <<text>>",
	edu.cmu.cs.stage3.alice.core.response.Print : "اطبع <<text>> <<object>>",
	edu.cmu.cs.stage3.alice.core.response.CallToUserDefinedResponse : "<userDefinedResponse><requiredActualParameters>",
	edu.cmu.cs.stage3.alice.core.response.ScriptResponse : "نص <<script>>",
	edu.cmu.cs.stage3.alice.core.response.ScriptDefinedResponse : "تحديد نص الرد <<script>>",
	edu.cmu.cs.stage3.alice.core.response.SayAnimation : "<<<subject>>> قل <<what>>",
	edu.cmu.cs.stage3.alice.core.response.ThinkAnimation : "<<<subject>>> فكر <<what>>",
	...
	edu.cmu.cs.stage3.alice.core.response.PoseAnimation : "<<<subject>>> ضبط الوضعية <<pose>>",
	edu.cmu.cs.stage3.alice.core.response.Increment : "زيادة <<<variable>>> بمقدار 1",
	edu.cmu.cs.stage3.alice.core.response.Decrement : "نقصان <<<variable>>> بمقدار 1",
        
        edu.cmu.cs.stage3.alice.core.response.VehiclePropertyAnimation : "<element> ضبط <propertyName> إلى <value>",

	edu.cmu.cs.stage3.alice.core.response.list.InsertItemAtBeginning : " إدراج <item> في البداية <<<list>>>",
	edu.cmu.cs.stage3.alice.core.response.list.InsertItemAtEnd : "إدراج <item> في النهاية <<<list>>>",
	edu.cmu.cs.stage3.alice.core.response.list.InsertItemAtIndex : "إدراج <item> في موضع <index> من <<<list>>>",
	edu.cmu.cs.stage3.alice.core.response.list.RemoveItemFromBeginning : " إزالة عنصر من البداية <<<list>>>",
	edu.cmu.cs.stage3.alice.core.response.list.RemoveItemFromEnd : " إزالة عنصر من النهاية <<<list>>>",
	edu.cmu.cs.stage3.alice.core.response.list.RemoveItemFromIndex : " إزالة عنصر من الموضع <index> من <<<list>>>",
	edu.cmu.cs.stage3.alice.core.response.list.Clear : " إزالة جميع العناصر من <<<list>>>",

	edu.cmu.cs.stage3.alice.core.response.array.SetItemAtIndex : "ضبط العنصر <index> إلى <item> في <<<array>>>",

	edu.cmu.cs.stage3.alice.core.response.vector3.SetX : "ضبط <<<vector3>>>'s المسافة إلى اليمين <<value>>",
	edu.cmu.cs.stage3.alice.core.response.vector3.SetY : "ضبط <<<vector3>>>'s المسافة إلى الأعلى <<value>>",
	edu.cmu.cs.stage3.alice.core.response.vector3.SetZ : "ضبط <<<vector3>>>'s المسافة إلى الأمام <<value>>",
	...
	edu.cmu.cs.stage3.alice.core.response.visualization.model.SetItem : "اجعل <<<subject>>> = <item>",

	edu.cmu.cs.stage3.alice.core.question.visualization.array.ItemAtIndex : "القيمة في <<<subject>>>[ <index> ]",
	edu.cmu.cs.stage3.alice.core.response.visualization.array.SetItemAtIndex : "اجعل <<<subject>>>[ <index> ] = <item>",
	...
	edu.cmu.cs.stage3.alice.core.response.visualization.list.InsertItemAtBeginning : "أضف <item> في بداية <<<subject>>>",
	edu.cmu.cs.stage3.alice.core.response.visualization.list.InsertItemAtEnd : "أضف <item> في نهاية <<<subject>>>",
	edu.cmu.cs.stage3.alice.core.response.visualization.list.InsertItemAtIndex : "أضف <item> في <index> من <<<subject>>>",
	edu.cmu.cs.stage3.alice.core.response.visualization.list.RemoveItemFromBeginning : "أزل العنصر من بداية <<<subject>>>",
	edu.cmu.cs.stage3.alice.core.response.visualization.list.RemoveItemFromEnd : "أزل العنصر من نهاية <<<subject>>>",
	edu.cmu.cs.stage3.alice.core.response.visualization.list.RemoveItemFromIndex : "أزل العنصر من <index> من <<<subject>>>",
	edu.cmu.cs.stage3.alice.core.response.visualization.list.Clear : "احذف <<<subject>>>",
}
...
nameMap = {
	"edu.cmu.cs.stage3.alice.core.response.DoInOrder" : "افعل بالتتابع",
	"edu.cmu.cs.stage3.alice.core.response.DoTogether" : "افعل بالتزامن",
	"edu.cmu.cs.stage3.alice.core.response.IfElseInOrder" : "إذا/غير ذلك",
	"edu.cmu.cs.stage3.alice.core.response.LoopNInOrder" : "حلقة تكرار",
	"edu.cmu.cs.stage3.alice.core.response.WhileLoopInOrder" : "بينما",
	"edu.cmu.cs.stage3.alice.core.response.ForEachInOrder" : "للجميع بالتتابع",
	"edu.cmu.cs.stage3.alice.core.response.ForEachTogether" : "للجميع بالتزامن",
	"edu.cmu.cs.stage3.alice.core.response.Print" : "اطبع",
	"edu.cmu.cs.stage3.alice.core.response.QuaternionAnimation.quaternion" : "بالمقابل",
	"edu.cmu.cs.stage3.alice.core.response.PointOfViewAnimation.pointOfView" : "زاوية النظر ل",
	"edu.cmu.cs.stage3.alice.core.response.PositionAnimation.position" : "بالمقابل",

	"edu.cmu.cs.stage3.alice.core.question.userdefined.Return" : "إرجاع",

	"edu.cmu.cs.stage3.alice.core.behavior.WorldStartBehavior" : "عندما يبدأ العالم",
	"edu.cmu.cs.stage3.alice.core.behavior.WorldIsRunningBehavior" : "أثناء تشغيل العالم",
	"edu.cmu.cs.stage3.alice.core.behavior.KeyClickBehavior" : "عندما <keyCode> يطبع",
	"edu.cmu.cs.stage3.alice.core.behavior.KeyIsPressedBehavior" : "عندما <keyCode> يُضغط",
	"edu.cmu.cs.stage3.alice.core.behavior.MouseButtonClickBehavior" : "عندما <mouse> يضغط على <onWhat>",
	"edu.cmu.cs.stage3.alice.core.behavior.MouseButtonIsPressedBehavior" : "بينما <mouse> يضغط على <onWhat>",
	"edu.cmu.cs.stage3.alice.core.behavior.ConditionalBehavior" : "بينما <condition> صحيح",
	"edu.cmu.cs.stage3.alice.core.behavior.ConditionalTriggerBehavior" : "عندما <condition> يصبح صحيح",
	"edu.cmu.cs.stage3.alice.core.behavior.VariableChangeBehavior" : "عندما <variable> يتغير",
	"edu.cmu.cs.stage3.alice.core.behavior.MessageReceivedBehavior" : "عند تلقي رسالة بواسطة  <toWhom> من <fromWho>", 
	"edu.cmu.cs.stage3.alice.core.behavior.DefaultMouseInteractionBehavior" : " دع <mouse> يتحرك <objects>",
	"edu.cmu.cs.stage3.alice.core.behavior.KeyboardNavigationBehavior" : " دع <arrowKeys> يتحرك <subject>",
	"edu.cmu.cs.stage3.alice.core.behavior.MouseNavigationBehavior" : " دع <mouse> يحرك الكاميرا",
	"edu.cmu.cs.stage3.alice.core.behavior.MouseLookingBehavior" : " دع <mouse> يوجّهه الكاميرا",
	"edu.cmu.cs.stage3.alice.core.behavior.SoundMarkerPassedBehavior" : "عندما علامة الصوت  <marker> يشتغل",
	"edu.cmu.cs.stage3.alice.core.behavior.SoundLevelBehavior" : "عندما يكون مستوى تسجيل الصوت >= <level>",
	...
	"edu.cmu.cs.stage3.alice.core.behavior.MouseButtonClickBehavior.onWhat" : "على ماذا",
	"edu.cmu.cs.stage3.alice.core.behavior.MouseButtonIsPressedBehavior.onWhat" : "على ماذا",
