...
formatMap = {
	...
	edu.cmu.cs.stage3.alice.core.response.QuaternionAnimation : "<<<subject>>>.توجه إلى( <asSeenBy> );",
	...
	edu.cmu.cs.stage3.alice.core.response.SoundResponse : "<<<subject>>>.شغل الصوت( <sound> );",
...
nameMap = {
	...
	"edu.cmu.cs.stage3.alice.core.behavior.MouseButtonClickBehavior" : "عندما <mouse>على  يضغط <onWhat>",
	...
	"edu.cmu.cs.stage3.alice.core.behavior.SoundLevelBehavior" : "عندما عندما يكون مستوى تسجيل الصوت >= <level>",
