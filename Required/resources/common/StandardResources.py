...
propertyNamesToOmit = [
	...
	("subject", "edu.cmu.cs.stage3.alice.core.responses.visualization.array.ArrayVisualizationAnimation"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.visualization.array.ArrayVisualizationWithItemAnimation"),
	("index", "edu.cmu.cs.stage3.alice.core.responses.visualization.array.SetItemAtIndex"),
	...
	("subject", "edu.cmu.cs.stage3.alice.core.responses.visualization.list.ListVisualizationAnimation"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.visualization.list.ListVisualizationWithItemAnimation"),
	("index", "edu.cmu.cs.stage3.alice.core.responses.visualization.list.InsertItemAtIndex"),
	("index", "edu.cmu.cs.stage3.alice.core.responses.visualization.list.RemoveItemFromIndex"),

	("subject", "edu.cmu.cs.stage3.alice.core.question.visualization.model.Item"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.visualization.model.SetItem"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.visualization.model.SetItem"),

	("subject", "edu.cmu.cs.stage3.alice.core.responses.TransformAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.DirectionAmountTransformAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.DirectionSpeedTransformResponse"),
	("direction", "edu.cmu.cs.stage3.alice.core.responses.DirectionAmountTransformAnimation"),
	("direction", "edu.cmu.cs.stage3.alice.core.responses.DirectionSpeedTransformResponse"),
	("amount", "edu.cmu.cs.stage3.alice.core.responses.DirectionAmountTransformAnimation"),
	("asSeenBy", "edu.cmu.cs.stage3.alice.core.responses.PositionAnimation"),
	("amount", "edu.cmu.cs.stage3.alice.core.responses.PlaceAnimation"),
	("spatialRelation", "edu.cmu.cs.stage3.alice.core.responses.PlaceAnimation"),
	("asSeenBy", "edu.cmu.cs.stage3.alice.core.responses.PlaceAnimation"),
	("asSeenBy", "edu.cmu.cs.stage3.alice.core.responses.PointOfViewAnimation"),
	("asSeenBy", "edu.cmu.cs.stage3.alice.core.responses.QuaternionAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.ResizeAnimation"),
	("dimension", "edu.cmu.cs.stage3.alice.core.responses.ResizeAnimation"),
	("amount", "edu.cmu.cs.stage3.alice.core.responses.ResizeAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.PointAtAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.PointAtConstraint"),
	("target", "edu.cmu.cs.stage3.alice.core.responses.PointAtAnimation"),
	("target", "edu.cmu.cs.stage3.alice.core.responses.PointAtConstraint"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.TurnToFaceAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.TurnToFaceConstraint"),
	("target", "edu.cmu.cs.stage3.alice.core.responses.TurnToFaceAnimation"),
	("target", "edu.cmu.cs.stage3.alice.core.responses.TurnToFaceConstraint"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.TurnAwayFromAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.TurnAwayFromConstraint"),
	("target", "edu.cmu.cs.stage3.alice.core.responses.TurnAwayFromAnimation"),
	("target", "edu.cmu.cs.stage3.alice.core.responses.TurnAwayFromConstraint"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.GetAGoodLookAtAnimation"),
	("target", "edu.cmu.cs.stage3.alice.core.responses.GetAGoodLookAtAnimation"),
	("element", "edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation"),
	("propertyName", "edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation"),
	("value", "edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.SoundResponse"),
	("sound", "edu.cmu.cs.stage3.alice.core.responses.SoundResponse"),
	("duration", "edu.cmu.cs.stage3.alice.core.responses.Wait"),
	("userDefinedResponse", "edu.cmu.cs.stage3.alice.core.responses.CallToUserDefinedResponse"),
	("requiredActualParameters", "edu.cmu.cs.stage3.alice.core.responses.CallToUserDefinedResponse"),
	("keywordActualParameters", "edu.cmu.cs.stage3.alice.core.responses.CallToUserDefinedResponse"),
	("condition", "edu.cmu.cs.stage3.alice.core.responses.IfElseInOrder"),
	...
	("list", "edu.cmu.cs.stage3.alice.core.responses.ForEach"),
	...
	("subject", "edu.cmu.cs.stage3.alice.core.responses.PoseAnimation"),
	("pose", "edu.cmu.cs.stage3.alice.core.responses.PoseAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.SayAnimation"),
	("what", "edu.cmu.cs.stage3.alice.core.responses.SayAnimation"),
	("subject", "edu.cmu.cs.stage3.alice.core.responses.ThinkAnimation"),
	("what", "edu.cmu.cs.stage3.alice.core.responses.ThinkAnimation"),
	("probabilityOfTrue", "edu.cmu.cs.stage3.alice.core.question.RandomBoolean"),
	("text", "edu.cmu.cs.stage3.alice.core.responses.Comment"),
	("text", "edu.cmu.cs.stage3.alice.core.responses.Print"),
	("object", "edu.cmu.cs.stage3.alice.core.responses.Print"),
	("variable", "edu.cmu.cs.stage3.alice.core.responses.Increment"),
	("variable", "edu.cmu.cs.stage3.alice.core.responses.Decrement"),
	("vector3", "edu.cmu.cs.stage3.alice.core.responses.vector3.Vector3Response"),
	("value", "edu.cmu.cs.stage3.alice.core.responses.vector3.Vector3Response"),
	...
	("list", "edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtBeginning"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtBeginning"),
	("list", "edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtEnd"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtEnd"),
	("list", "edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtIndex"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtIndex"),
	("index", "edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtIndex"),
	("list", "edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromBeginning"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromBeginning"),
	("list", "edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromEnd"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromEnd"),
	("list", "edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromIndex"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromIndex"),
	("index", "edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromIndex"),
	("list", "edu.cmu.cs.stage3.alice.core.responses.list.Clear"),

	("array", "edu.cmu.cs.stage3.alice.core.responses.array.SetItemAtIndex"),
	("item", "edu.cmu.cs.stage3.alice.core.responses.array.SetItemAtIndex"),
	("index", "edu.cmu.cs.stage3.alice.core.responses.array.SetItemAtIndex"),
...
#	("valueClass", "edu.cmu.cs.stage3.alice.core.question.VariableNamed"),
	...
	("a", "edu.cmu.cs.stage3.alice.core.question.StringToUpperCaseQuestion"),
	("a", "edu.cmu.cs.stage3.alice.core.question.StringToLowerCaseQuestion"),
...
["edu.cmu.cs.stage3.alice.core.responses.visualization.array.SetItemAtIndex",
	["index",
		Double( 0.0 ),
		Double( 1.0 ),
		Double( 2.0 ),
...
["edu.cmu.cs.stage3.alice.core.responses.visualization.list.InsertItemAtIndex",
	["index",
		Double( 0.0 ),
		Double( 1.0 ),
		Double( 2.0 ),
...
["edu.cmu.cs.stage3.alice.core.responses.visualization.list.RemoveItemFromIndex",
	["index",
		Double( 0.0 ),
		Double( 1.0 ),
		Double( 2.0 ),
...
["edu.cmu.cs.stage3.alice.core.responses.LoopNInOrder",
	["start",
		Double( 0 ),
		Double( 1 ),
		Double( 2 ),
...
["edu.cmu.cs.stage3.alice.core.responses.SendMessage",
	["message",
		String( "ping" ),
	]
],
["edu.cmu.cs.stage3.alice.core.responses.SayAnimation",
	["what",
		String( "Hello" ),
		String( "Goodbye" ),
	]
],
["edu.cmu.cs.stage3.alice.core.responses.ThinkAnimation",
	["what",
		String( "I wonder" ),
	]
],
["edu.cmu.cs.stage3.alice.core.responses.AbstractBubbleAnimation",
	["fontSize",
		Integer( 20 ),
		Integer( 25 ),
		Integer( 30 ),
...
["edu.cmu.cs.stage3.alice.core.responses.MoveAnimation",
	["amount",
		Double( .5 ),
		Double( 1 ),
		Double( 5 ),
...
["edu.cmu.cs.stage3.alice.core.responses.ResizeAnimation",
	["amount",
		Double( .5 ),
		Double( 2 ),
	]
],
["edu.cmu.cs.stage3.alice.core.responses.MoveAtSpeed",
	["speed",
		Double( .5 ),
		Double( 1 ),
		Double( 5 ),
...
["edu.cmu.cs.stage3.alice.core.responses.RotateAnimation",
	["amount",
		Double( .25 ),
		Double( .5 ),
		Double( 1 ),
...
["edu.cmu.cs.stage3.alice.core.responses.RotateAtSpeed",
	["speed",
		Double( .25 ),
		Double( .5 ),
		Double( 1 ),
...
["edu.cmu.cs.stage3.alice.core.responses.TurnAnimation",
	["direction",
...
["edu.cmu.cs.stage3.alice.core.responses.TurnAtSpeed",
	["direction",
		edu.cmu.cs.stage3.alice.core.Direction.LEFT,
		edu.cmu.cs.stage3.alice.core.Direction.RIGHT,
		edu.cmu.cs.stage3.alice.core.Direction.FORWARD,
...
["edu.cmu.cs.stage3.alice.core.responses.RollAnimation",
	["direction",
		edu.cmu.cs.stage3.alice.core.Direction.LEFT,
		edu.cmu.cs.stage3.alice.core.Direction.RIGHT,
	]
],
["edu.cmu.cs.stage3.alice.core.responses.RollAtSpeed",
	["direction",
		edu.cmu.cs.stage3.alice.core.Direction.LEFT,
		edu.cmu.cs.stage3.alice.core.Direction.RIGHT,
	]
...
["edu.cmu.cs.stage3.alice.core.responses.DirectionAmountTransformAnimation",
	["direction",
...
["edu.cmu.cs.stage3.alice.core.responses.DirectionSpeedTransformResponse",
	["direction",
		edu.cmu.cs.stage3.alice.core.Direction.UP,
		edu.cmu.cs.stage3.alice.core.Direction.DOWN,
		edu.cmu.cs.stage3.alice.core.Direction.LEFT,
...
["edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtIndex",
	["index",
		Double( 0.0 ),
		Double( 1.0 ),
		Double( 2.0 ),
...
["edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromIndex",
	["index",
		Double( 0.0 ),
		Double( 1.0 ),
		Double( 2.0 ),
...
["edu.cmu.cs.stage3.alice.core.responses.array.SetItemAtIndex",
	["index",
		Double( 0.0 ),
		Double( 1.0 ),
		Double( 2.0 ),
...
propertyValueFormatMap = {
	...
	"edu.cmu.cs.stage3.alice.core.responses.LoopNInOrder.end" : {
	...
	"edu.cmu.cs.stage3.alice.core.responses.MoveAnimation.amount" : {
		Double( 1.0 ) : "<value> <distanceUnit>",
		"default" : "<value> <distanceUnits>",
	},
	"edu.cmu.cs.stage3.alice.core.responses.MoveAnimation.amount.menuContext" : {  # for values shown in a menu
	...
	"edu.cmu.cs.stage3.alice.core.responses.ResizeAnimation.amount.menuContext" : {  # for values shown in a menu
		Double( .5 ) : "1/2 (half as big)",
		Double( 2.0 ) : "2 (twice as big)",
		"default" : "<value>",
	},
	"edu.cmu.cs.stage3.alice.core.responses.MoveAwayFromAnimation.amount" : {
		Double( 1.0 ) : "<value> <distanceUnit>",
		"default" : "<value> <distanceUnits>",
	},
	"edu.cmu.cs.stage3.alice.core.responses.MoveAwayFromAnimation.amount.menuContext" : {  # for values shown in a menu
		Double( .25 ) : "1/4 <distanceUnit>",
		Double( .5 ) : "1/2 <distanceUnit>",
		Double( .75 ) : "3/4 <distanceUnit>",
		Double( 1.0 ) : "1 <distanceUnit>",
	...
	"edu.cmu.cs.stage3.alice.core.responses.MoveTowardAnimation.amount" : {
		Double( 1.0 ) : "<value> <distanceUnit>",
		"default" : "<value> <distanceUnits>",
	},
	"edu.cmu.cs.stage3.alice.core.responses.MoveTowardAnimation.amount.menuContext" : {  # for values shown in a menu
		Double( .25 ) : "1/4 <distanceUnit>",
		Double( .5 ) : "1/2 <distanceUnit>",
		Double( .75 ) : "3/4 <distanceUnit>",
		Double( 1.0 ) : "1 <distanceUnit>",
	...
	"edu.cmu.cs.stage3.alice.core.responses.MoveAtSpeed.speed" : {
		Double( 1.0 ) : "<value> <distanceVelocityUnit>",
		"default" : "<value> <distanceVelocityUnits>",
	},
	"edu.cmu.cs.stage3.alice.core.responses.MoveAtSpeed.speed.menuContext" : {  # for values shown in a menu
	...
	"edu.cmu.cs.stage3.alice.core.responses.RotateAnimation.amount" : {
		Double( 1.0 ) : "<value> <revolutionUnit>",
		"default" : "<value> <revolutionUnits>",
	},
	"edu.cmu.cs.stage3.alice.core.responses.RotateAnimation.amount.menuContext" : {  # for values shown in a menu
	...
	"edu.cmu.cs.stage3.alice.core.responses.SoundResponse.fromMarker" : {
		None : "Start of Sound",
	},
	"edu.cmu.cs.stage3.alice.core.responses.SoundResponse.toMarker" : {
		None : "End of Sound",
	},
...
["edu.cmu.cs.stage3.alice.core.visualization.ModelVisualization",
	["common animations",
		"edu.cmu.cs.stage3.alice.core.responses.visualization.model.SetItem",
		
		"edu.cmu.cs.stage3.alice.core.responses.MoveAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.TurnAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.RollAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.ResizeAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.TurnToFaceAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.PointAtAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.StandUpAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.PositionAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.QuaternionAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.PointOfViewAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.SoundResponse",
#		"edu.cmu.cs.stage3.alice.core.responses.SendMessage",
		"edu.cmu.cs.stage3.alice.core.responses.PoseAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.SayAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.MoveTowardAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.MoveAwayFromAnimation",
		["property animations",
			"edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation<color>",
			"edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation<opacity>",
			"edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation<vehicle>",
			"edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation<diffuseColorMap>",
			"edu.cmu.cs.stage3.alice.core.responses.PropertyAnimation<fillingStyle>",
		],
	],
	...
	["constraints",
		"edu.cmu.cs.stage3.alice.core.responses.TurnToFaceConstraint",
		"edu.cmu.cs.stage3.alice.core.responses.PointAtConstraint",
	],
],
...
["edu.cmu.cs.stage3.alice.core.visualization.ListOfModelsVisualization",
	["common animations",
		"edu.cmu.cs.stage3.alice.core.responses.visualization.list.InsertItemAtBeginning",
		"edu.cmu.cs.stage3.alice.core.responses.visualization.list.InsertItemAtEnd",
		"edu.cmu.cs.stage3.alice.core.responses.visualization.list.InsertItemAtIndex",
		"edu.cmu.cs.stage3.alice.core.responses.visualization.list.RemoveItemFromBeginning",
		"edu.cmu.cs.stage3.alice.core.responses.visualization.list.RemoveItemFromEnd",
		"edu.cmu.cs.stage3.alice.core.responses.visualization.list.RemoveItemFromIndex",
		"edu.cmu.cs.stage3.alice.core.responses.visualization.list.Clear",
...
["edu.cmu.cs.stage3.alice.core.Camera",
	...
	["advanced animations",
		"edu.cmu.cs.stage3.alice.core.responses.GetAGoodLookAtAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.PositionAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.MoveTowardAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.MoveAwayFromAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.QuaternionAnimation",
...
["edu.cmu.cs.stage3.alice.core.Model",
	...
	["advanced animations",
		...
		"edu.cmu.cs.stage3.alice.core.responses.QuaternionAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.TurnToFaceAnimation",
#		"edu.cmu.cs.stage3.alice.core.responses.TurnAwayFromAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.PointAtAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.PointOfViewAnimation",
		"edu.cmu.cs.stage3.alice.core.responses.PoseAnimation",	
		"edu.cmu.cs.stage3.alice.core.responses.StandUpAnimation",
	...
	["constraints",
		"edu.cmu.cs.stage3.alice.core.responses.TurnToFaceConstraint",
#		"edu.cmu.cs.stage3.alice.core.responses.TurnAwayFromConstraint",
		"edu.cmu.cs.stage3.alice.core.responses.PointAtConstraint",
	],
],
["edu.cmu.cs.stage3.alice.core.List",
	["common animations",
		"edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtBeginning",
		"edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtEnd",
		"edu.cmu.cs.stage3.alice.core.responses.list.InsertItemAtIndex",
		"edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromBeginning",
		"edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromEnd",
		"edu.cmu.cs.stage3.alice.core.responses.list.RemoveItemFromIndex",
		"edu.cmu.cs.stage3.alice.core.responses.list.Clear",
	],
],
...
["java.lang.Number",
	["common animations",
		"edu.cmu.cs.stage3.alice.core.responses.Increment",
		"edu.cmu.cs.stage3.alice.core.responses.Decrement",
	],
],
["javax.vecmath.Vector3d",
	["common animations",
		"edu.cmu.cs.stage3.alice.core.responses.vector3.SetX",
		"edu.cmu.cs.stage3.alice.core.responses.vector3.SetY",
		"edu.cmu.cs.stage3.alice.core.responses.vector3.SetZ",
	],
],
]
...
["edu.cmu.cs.stage3.alice.core.World",
	...
	["string",
		...
		"edu.cmu.cs.stage3.alice.core.question.StringToUpperCaseQuestion",
		"edu.cmu.cs.stage3.alice.core.question.StringToLowerCaseQuestion",
...
mainUpdateURL = "http://www.alice.org/get-alice/alice-2/updates/"
